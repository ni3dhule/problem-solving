...
public class SubIslandCount {
    private static int m;  // Number of rows in the grid
    private static int n;  // Number of columns in the grid

    private static boolean isSubIsland;  // Flag to track if the current island in grid2 is a sub-island of grid1
